...
enum reg_class
{
	reg_GPR8=0<<5,		//8 bit regs   (al,cl,dl,bl,ah,cd,dh,bh // r0b .. r3b)
	reg_GPR16=0<<5,		//16 bit regs  (ax,cx,dx,bx,sp,bp,si,di // ax,cx,dx,bx,sp,bp,si,di,r8w,r9w,r10w,r11w,r12w,r13w,r14w,r15w // r0w .. r15w)
	reg_GPR32=0<<5,		//32 bit regs  (eax,ecx,edx,ebx,esp,ebp,esi,edi)
	reg_MMX=0<<5,		//mmx regs     (mm0 .. mm7 // mm0 .. mm15)
	reg_SSE=0<<5,		//sse regs     (xmm0 .. xmm7 // xmm0 .. xmm15)
#ifdef X64
